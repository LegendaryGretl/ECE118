...
#define TAPE_SENSOR_SL PORTY10_BIT // side left 
#define TAPE_SENSOR_SL_TRIS PORTY10_TRIS
#define TAPE_SENSOR_SL_AD AD_PORTW3

#define TAPE_SENSOR_SR PORTY09_BIT // side right
#define TAPE_SENSOR_SR_TRIS PORTY09_TRIS
#define TAPE_SENSOR_SR_AD AD_PORTW4

#define TAPE_SENSOR_TC PORTY08_BIT // top center
