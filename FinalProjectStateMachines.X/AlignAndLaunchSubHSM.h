...
#ifndef ALIGN_AND_LAUNCH_SUB_HSM_H  // <- This should be changed to your own guard on both
#define ALIGN_AND_LAUNCH_SUB_HSM_H  //    of these lines
...
#endif /* ALIGN_AND_LAUNCH_SUB_HSM_H */
