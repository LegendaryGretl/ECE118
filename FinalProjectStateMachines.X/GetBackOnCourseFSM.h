...
#ifndef GET_BACK_ON_COURSE_FSM_H  // <- This should be changed to your own guard on both
#define GET_BACK_ON_COURSE_FSM_H  //    of these lines
...
#endif /* GET_BACK_ON_COURSE_FSM_H */
