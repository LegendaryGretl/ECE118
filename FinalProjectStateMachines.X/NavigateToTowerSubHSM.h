...
#ifndef NAVIGATE_TO_TOWER_SUB_HSM_H  // <- This should be changed to your own guard on both
#define NAVIGATE_TO_TOWER_SUB_HSM_H  //    of these lines
...
#endif /* NAVIGATE_TO_TOWER_SUB_HSM_H */
